...
var Route$2 = createRootRouteWithContext()({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "A magical interactive birthday gift box filled with scrapbook memories, handwritten letters, fresh flowers, and birthday surprises."
			},
			{
				name: "author",
				content: "With Love"
			...
			{
				property: "og:title",
				content: "Iram's Birthday Memory Box | A Sister's Gift"
			},
			{
