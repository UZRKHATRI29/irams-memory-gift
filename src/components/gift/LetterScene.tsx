      ...
      <div className="mt-10 flex flex-col items-center">
        <AnimatePresence mode="wait">
          {!isOpen ? (
            ...
            >
              <div className="relative h-[230px] w-[280px] rounded-xl border border-walnut/30 bg-beige/90 p-4 shadow-lift transition-transform duration-500 group-hover:scale-105 sm:h-[300px] sm:w-[420px]">
                ...
                <motion.div
                  ...
                  className="absolute left-1/2 top-1/2 z-10 flex h-14 w-14 sm:h-16 sm:w-16 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full bg-rose shadow-lg ring-4 ring-cream/80"
                >
                  <Heart className="h-6 w-6 sm:h-7 sm:w-7 text-cream fill-cream/30" />
                </motion.div>

                {/* Front label */}
                <div className="absolute bottom-4 sm:bottom-6 left-1/2 -translate-x-1/2 text-center">
                  <p className="hand text-xl sm:text-2xl text-cocoa">For {settings?.recipient_name || "Iram"}</p>
                  <p className="mt-0.5 text-[10px] sm:text-xs text-walnut/60 uppercase tracking-widest">
                    Tap to open letter
                  </p>
                </div>
              </div>
            ...
            <motion.div
              ...
              className="relative w-full rounded-2xl border border-walnut/25 bg-cream p-5 sm:p-12 shadow-paper paper"
            >
